...
import { FaUserAlt, FaClock, FaFacebook, FaInstagram,FaEnvelope,FaPhone, FaMoneyBill } from "react-icons/fa";
                ...
                <div className=" md:w-2/3">
                    <div className="flex justify-between w-full flex-col sm:flex-row">
                        ...
                        <div className="flex flex-wrap items-center gap-3 ">
                            <label className="flex flex-row gap-1 items-center"><FaClock/> {tour.time}</label>
                            <label className="flex flex-row gap-1 items-center"><FaMoneyBill/> {`$ ${tour.price}`}</label>
                        </div>
                    ...
                    <div className="container mx-auto grid grid-cols-2 md:grid-cols-3 gap-3 ">
                        {
                            tour.gallery.map((image,i) => {
                                return(
                                    ...
                                    <Image key={i} src={image} width={500} height={500} alt={tour.title} className="w-full h-60 object-cover"/>
